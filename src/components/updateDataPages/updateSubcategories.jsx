...
function UpdateSubcategories({singleData,onUpdate}) {
...
useEffect(()=>{
  ...
  const onSubmit = async () => {
    try {
      const response = await axios.put(`${BASE_URL}/UpdatesubcategoriesData/${singleData.id}`, formData, {
        headers: {
          Authorization: `Bearer ${token}`,
      },
      });
                ...
                <div className="col-xxl-4 col-xl-4 col-lg-6">
                  <div className="card">
                    <div className="card-header">
                      <h4 className="card-title">change subcategories</h4>
                    </div>
