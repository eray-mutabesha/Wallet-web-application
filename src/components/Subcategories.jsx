...
import UpdateSubcategories from "./updateDataPages/updateSubcategories";
...
function Subcategories() {
   ...
   const onSubmit = async () => {
    try {
      const response = await axios.post(`${BASE_URL}/InsertSubcategoriesData`, formData,{
        headers: {
...
//Delete subcategories data
const HandleDelete = (model) => {
  console.log(model)
axios.delete(`${BASE_URL}/DeletesubcategoriesData/${model.id}`,{
      headers: {
          Authorization: `Bearer ${token}`,
      },
  }
...
<Header/>
            ...
            <div className="col-xxl-4 col-xl-4 col-lg-6">
              <div className="card">
                <div className="card-header">
                  <h4 className="card-title">Create new Subcategories</h4>
                </div>
                <div className="card-body">
                  <div className="create-new-category">
                    ...
                    <div className="mb-3 col-12">
                        ...
                        <input type="text" className="form-control" placeholder="Subcategories name"
                      ...
                      <div className="mb-3 col-12">
                          <label className="form-label">Categories Type</label>
                      ...
                      <div className="col-12">
                        <button className="btn btn-success w-100">Create new Subcategories</button>
                      </div>
                    </form>
                  </div>
                </div>
                    ...
                    <ul>
                      {
                        SubcategoriesDatas.map((data,index)=>(
                          ...
                          <div className="left-category" style={{display:"flex",gap:"20px"}}>
                          <span className="drag-icon"><i className="fi fi-ss-grip-lines" /></span>
                           <span className="category-icon" style={{width:"300px"}}>
                           
                            <i className="bg-purple-500 fi fi-rr-money-bills-simple" />
                              {data.name}</span>
  ...
  <div className="footer">
    ...
    return <UpdateSubcategories singleData={singleData}  onUpdate={handleUpdate}/>
  }
}
